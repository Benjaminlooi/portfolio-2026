			...
			<div className="flex gap-6 flex-col md:flex-row items-center">
				...
				<AnimationContainer className="w-full py-12 lg:py-16">
					...
					<div className="w-full space-y-4 text-base font-normal leading-7 text-neutral-200">
						<p>
							I&apos;m Benjamin — a software engineer from Malaysia with 5+
							years of professional experience building enterprise software.
							Most of my career has been spent at tech companies in Kuala
							Lumpur, where I worked across the stack on HR management systems
							and point-of-sale platforms — from React and Vue frontends to
							Laravel and Node.js backends.
						</p>
						<p>
							At my most recent role at{" "}
							<span className="text-white font-medium">TalentCloud AI</span>, I
							spent three years as a Senior Full Stack Developer — leading a
							frontend migration to a Nuxt.js monorepo, building complex
							...
							at <span className="text-white font-medium">Platinum Code</span>,
						...
						<p>
							...
							Astro. On the side, I tinker with network security tools like Nmap
							and Burp Suite — not as a career pivot, just because I like
							understanding how things break.
						</p>
						<p>
							I&apos;m looking for a remote role — ideally with a product team
							where I can own features end-to-end and work closely with users.
						</p>
					</div>
				</AnimationContainer>
			</div>
