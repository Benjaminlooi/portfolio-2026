...
export const metadata: Metadata = generatePageMetadata(
  {
    ...
    description: "Learn about Benjamin Looi's journey as a Software Engineer and UX Enthusiast. Passionate about building user-centric web applications with modern technologies.",
  },
  "/about"
);
...
const About = () => {
  ...
  const personSchema = buildPersonSchema({
    ...
    description: "Software Engineer and UX Enthusiast passionate about building user-centric web applications",
