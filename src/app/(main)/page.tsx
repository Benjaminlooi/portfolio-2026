...
export const metadata: Metadata = generatePageMetadata(
	{
		...
		description:
			"Software engineer with 5+ years building enterprise SaaS products across the full stack. Deep expertise in React, TypeScript, and Next.js, with hands-on backend and DevOps experience. Currently based in Cambodia, open to remote opportunities.",
	},
	"/",
);
...
const Home = () => {
	...
	const personSchema = buildPersonSchema({
		...
		description:
			"Software engineer with 5+ years building enterprise SaaS products across the full stack",
