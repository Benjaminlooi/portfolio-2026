---
title: "Sokha Tech"
description: "A bilingual marketing platform I built for a tech consultancy in Cambodia, designed to help local SMEs adopt digital tools — from websites and SEO to POS systems."
date: "2025-01-01"
type: "web"
...
Sokha Tech is the online presence for a tech consultancy I built that helps Cambodian SMEs adopt digital tools — from websites and SEO to POS systems and AI automation. I designed and developed the entire platform end-to-end, from concept through deployment. One of the products connected to that work is [Baguette POS](/projects/baguette-pos), a restaurant point-of-sale system built for the same local SME market.
...
The biggest lesson was that good messaging matters more than good design. The first version of the site looked great but had generic copy ("We build digital solutions for your business"). Once I rewrote the content around specific pain points I'd heard from actual business owners, I started getting noticeably more inquiries — the messaging was doing far more work than the visual design. The design supports the message, but the message does the heavy lifting.
