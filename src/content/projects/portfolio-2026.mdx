...
After the initial build, I ran Lighthouse audits and systematically addressed every issue, ultimately achieving a 98/100 performance score and reducing Largest Contentful Paint (LCP) to under 1.2 seconds. The key optimizations were:
