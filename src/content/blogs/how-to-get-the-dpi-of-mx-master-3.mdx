...
summary: "Find the DPI value behind the MX Master 3 pointer-speed percentage in Logi Options+."
metaDescription: "Find the exact DPI of your Logitech MX Master 3 mouse when Logi Options+ only shows percentages. Includes a full DPI-to-percentage conversion table."
image: "/images/blogs/mx-master-3-dpi/mx_master_3s_logi_options+.webp"
author: "Benjamin Looi"
publishedAt: "2022-11-04"
tags: ["logitech", "mx-master-3", "dpi", "mouse", "peripherals", "hardware"]
---

Logi Options+ shows MX Master 3 pointer speed as a percentage instead of an exact DPI value.
...
![Logi Options+ for MX Master 3s](/images/blogs/mx-master-3-dpi/mx_master_3s_logi_options+.webp)
